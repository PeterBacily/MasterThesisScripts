...
datareduc.plot_TVS_Lapalma_masterfile(apo_lines2,plot_save_folder=r'D:\peter\Master_Thesis\Datareduction\Plots\TVS\mercator',datafilefolder=r'D:\peter\Master_Thesis\Datareduction\Converted_Data\mercator\ll_apo\\',show='on', save='off', sg='off', oneline='on', siglvlline=0.01, norm_boundaries='on',style = None,vrange=1000)
