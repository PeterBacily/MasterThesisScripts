...
run_cddo(snr=None,df=str(Data_folder)+r'\Demetra\Zet_Ori_Data_Zet_Ori_Response3\final_spectra\\',sf=str(converted_Data_folder)+r'\demetra\with_orders\all_darks\single_obs\\', note=notitie)
