...
class Datafile_mercator_omar:
    ...
    def __init__(self, file,ll_file=None,v_rad = 18.5,i=None):
        ...
        self.wl_rebin05, self.flux_rebin05 = airmass.rebin2(self.wl_original, self.flux_original, step=0.5)
        self.wl_rebin025, self.flux_rebin025 = airmass.rebin2(self.wl_original, self.flux_original, step=0.25)
        self.wl_rebin03, self.flux_rebin03 = airmass.rebin2(self.wl_original, self.flux_original, step=0.3)
        self.wl_rebin02, self.flux_rebin02 = airmass.rebin2(self.wl_original,self.flux_original,step=0.2)
        ...
        for line in self.linelist:
            ...
            linedata_rebin025, lk = line_data(line, self.wl_rebin025, self.flux_rebin025, self.observatory, self.snr, 0, 0)
            linedata_rebin03, lk = line_data(line, self.wl_rebin03, self.flux_rebin03, self.observatory, self.snr, 0, 0)
            ...
            setattr(self, linekey + '_rebin025', linedata_rebin025)
            setattr(self, linekey + '_rebin03', linedata_rebin03)
