...
notitie = 'All darks, closest set of flat flatfields and single night bias, aD_csfF_snB'
run_cddo(snr=None,df=str(Data_folder)+r'\Demetra\all_darks\full_night\\',sf=str(converted_Data_folder)+r'\demetra\with_orders\all_darks\full_night\\', note=notitie,filename_prefix='all_dark')
