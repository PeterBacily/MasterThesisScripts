...
for i in range(len(pfs)):
    datareduc.plot_TVS_orders(apo_lines2, plot_save_folder=pfs[i], show='off', save='on', sg='off', oneline='on', siglvlline=0.01,datafilefolder=dfs[i], norm_boundaries='on',vrange=1000)
