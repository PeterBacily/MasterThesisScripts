...
ll_lapalma2 = [[r'Ha', 6562.819, 6551, 6552, 6578, 6579]]

def equivalent_width(velo,flux,linecenter,snr, vlim=450):
    # print wl, linecenter
    # velo = airmass.wl_to_velocity(wl,linecenter)
    # print vsini
...
for line in ll_lapalma:
    ...
    np.save('C:\peter\School\Master Scriptie\Data\EW\lp\\'+linename+'_nn.npy',dat2)
